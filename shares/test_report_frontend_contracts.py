...
class ReportFrontendContractTests(TestCase):
    ...
    def test_report_templates_use_shared_moderation_components_and_one_resolution_form(self):
        ...
        self.assertIn('id="moderation-report-page"', queue_source)
        self.assertIn('id="moderation-report-page"', detail_source)
        self.assertIn('hx-target="#moderation-report-page"', queue_source)
        self.assertIn('hx-select="#moderation-report-page"', detail_source)
