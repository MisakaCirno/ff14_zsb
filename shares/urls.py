...
urlpatterns = [
    ...
    path('staff/restrictions/', moderation.admin_restriction_list, name='admin_restriction_list'),
    path('staff/restrictions/<str:share_id>/takedown/', moderation.admin_takedown_share, name='admin_takedown_share'),
